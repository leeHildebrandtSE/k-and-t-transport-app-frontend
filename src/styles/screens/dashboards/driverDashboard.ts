...
export const driverDashboardStyles = StyleSheet.create({
  ...
  driverNameHome: {
    ...
    textShadow: `0px 1px 3px ${colors.primary}20`,
  },
  ...
  dutyStatusText: {
    ...
    textShadow: '0px 2px 8px rgba(245, 158, 11, 0.3)',
  },
  ...
  premiumCardTitle: {
    ...
    textShadow: `0px 1px 2px ${colors.tertiary}15`,
  },
  ...
  // Background blob 3 for Cape Town sunshine effect
  backgroundBlob3: {
    position: 'absolute',
    width: width * 0.4,
    height: width * 0.4,
  ...
  // Premium Passengers Screen Styles
